...
const SENDFOX_CHILD_NAME_FIELD_NAME = Deno.env.get('SENDFOX_CHILD_NAME_FIELD_NAME') || 'child_name';
    ...
    const sendfoxRes = await fetch('https://api.sendfox.com/contacts', {
      ...
      body: JSON.stringify({
        ...
        contact_fields: candidate.child_full_name
          ? [{ name: SENDFOX_CHILD_NAME_FIELD_NAME, value: candidate.child_full_name }]
          : undefined,
      }),
    });
