...
Grade 5 typical weekly schedule (verify against actual school schedule):
...
> MAPEH and EPP (ICT in Q1, AFA/FCS/IA in Q2–Q4) rotate through the week — confirm with the learner's actual schedule. On weeks where MAPEH or EPP is covered, add it to the relevant day.
