          ...
          >
            {!isUnlocked ? (
              ...
              <button
                ...
                className="w-full flex items-center gap-4 text-left btn-tactile"
              >
            ...
            return (
              <div key={bm.id} className="p-4 rounded-xl border border-cyan-900 bg-cyan-900/10">
                <div className="flex items-center gap-4">
                  <button onClick={() => setDetailMonster(bm)} className="flex flex-1 items-center gap-4 text-left btn-tactile min-w-0">
