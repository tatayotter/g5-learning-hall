        ...
        <div className="bg-white/90 border border-stone-200 rounded-2xl shadow-sm p-8 text-center">
          ...
          <h2 className="text-2xl mb-2" style={{ fontFamily: questButtonFontFamily, letterSpacing: questButtonLetterSpacing }}>
            <span style={{ position: 'relative', display: 'inline-block' }}>
              <span aria-hidden style={questTextShadowStyle}>Logic Labyrinth</span>
              <span style={{ ...questTextStyle, color: '#22d3ee' }}>Logic Labyrinth</span>
            </span>
          </h2>
        ...
        <div className="flex flex-col landscape:flex-row flex-1 min-h-0">
          ...
          <div className="p-4 flex flex-col gap-3 flex-1">
            ...
            <div className="flex flex-col gap-3 mt-auto pt-2">
              <GameButton variant="quest" color="#0e7490" onClick={() => { engine.start(); setScreen('playing'); }} className="w-full" style={{ fontSize: 15 }}>⚔️ Play Again</GameButton>
