...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    description:
      "A plain-English explainer on DepEd's Special Science Elementary School program — what it actually is, how the qualifying exam works, and what Learning Hall's own 'SSES enrichment' label does and doesn't mean.",
    guildKey: 'resources',
    guildName: 'Resources',
    skill: 'Resources',
    grade: 'all',
