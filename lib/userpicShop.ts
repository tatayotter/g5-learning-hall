...
export const USERPIC_CATALOG: UserpicItem[] = [
  ...
  { key: 'userpic_purplegirl',  file: 'purplegirl.png',  name: 'Purple Girl',  cost: 600 },
  { key: 'userpic_blondegirl',  file: 'blondegirl.png',  name: 'Blonde Girl',  cost: 600 },
  { key: 'userpic_outdoorgirl', file: 'outdoorgirl.png', name: 'Outdoor Girl', cost: 600 },
